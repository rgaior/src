...
#ifndef _utl_AugerSystemOfUnits_h_
#define _utl_AugerSystemOfUnits_h_
...
namespace utl {
  ...
  /**
     ...
     \version $Id: AugerUnits.h 746 2012-01-31 13:27:22Z fwerner $
  ...
  */
  ...
  const double milliWatt = milli*watt;
  ...
  // dBm to power
  inline double dBmToPower(const double dBmVal) {
    return pow(10.,dBmVal/10.)*milliWatt;
  }

  // power to dBm
  inline double powerToDBm(const double power) {
    return 10.*log10(power/milliWatt);
  }
