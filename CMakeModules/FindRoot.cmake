...
IF (Root_FOUND)
  ...
  #add mathmore
  FIND_LIBRARY (ROOT_MATHMORE_LIB MathMore ${ROOT_LIBDIR} NO_DEFAULT_PATH)

  IF (ROOT_MATHMORE_LIB)
    SET (ROOT_LDFLAGS "${ROOT_LDFLAGS} -lMathMore")
    SET (ROOT_MATHMORE_LIB ${ROOT_MATHMORE_LIB} CACHE INTERNAL "" FORCE)
  ELSE (ROOT_MATHMORE_LIB)
    MESSAGE(FATAL_ERROR "Could not find MathMore library in ${ROOT_LIBDIR}")
  ENDIF (ROOT_MATHMORE_LIB)
  LIST (APPEND ROOT_LIBRARIES ${ROOT_MATHMORE_LIB})
...
MACRO (ROOT_GENERATE_DICTIONARY _NAME)
  ...
  FOREACH (_current_FILE ${${_NAME}_INCLUDE_DIRS} ${_DIR_INCLUDES})
    # Avoid rootcint bug: exclude /usr/include
    IF ( NOT _current_FILE STREQUAL "/usr/include" )
      SET (_INCLUDE_DIRS ${_INCLUDE_DIRS} -I${_current_FILE})
    ENDIF ( NOT _current_FILE STREQUAL "/usr/include" )
